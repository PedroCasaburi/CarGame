...
public class MainActivity extends AppCompatActivity {
    ...
    public class GameView extends View {
        ...
        private void iniciar() {
            ...
            paintCarroVindo.setColor(Color.BLUE);
            random = new Random();
        ...
        private void atualizar() {
            // Mantém o carro do jogador no meio da tela
            ...
            for (int i = 0; i < carros.size(); i++) {
                ...
                if (carro.getY() > getHeight()) {
                    ...
                    // Verifica se houve colisão entre os carros
            ...
            // Cria um novo carro aleatoriamente
            ...
            // Incrementa a pontuação a cada frame
            pontuacao++;
        }

        private void reiniciarJogo() {
            // Redefine todas as variáveis necessárias para colocar o jogo em seu estado inicial
